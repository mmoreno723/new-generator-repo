...
function generatePassword() {
  ...
  var confirmSpecialCharacter = confirm(
    "Click OK if you would like special characters in your password."
  );
  var confirmNumber = confirm(
    "Click OK if you would like numbers in your password."
  );
  var confirmLowercase = confirm(
    "Click OK if you would like lowercase letters in your password."
  );
  var confirmUppercase = confirm(
    "Click OK if you would like uppercase letters in your password."
  );
